...
public class Sign_in extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("E.g. John@mail.com");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().isEmpty() || jPasswordField1.getText().isEmpty())
            ...
            try
                {
                  ...
                  String query="Select Upass,Uname from user where Umail like '"+em+"'";
            ...
            String nm=jLabel6.getText();
            if(p.equals(pass))
            {
                JOptionPane.showMessageDialog(this, "You have sucessfully loged in ! Welcome "+ nm +" 😄");
                new Product_Carousel(em,0).setVisible(true);
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        try
        {
          ...
          con=c1.connect();
          Statement stmt= (Statement) con.createStatement();
          String query="Select Umail from user where Umail like '"+em+"'";
          ResultSet rs= stmt.executeQuery(query);
          while(rs.next())
          {
              String ml=rs.getString("Umail");
              if(ml.equals(em))
                  t=1;
          }
        ...
        if(t==0)
            JOptionPane.showMessageDialog(this, "Email ID not found in our database ☹");  
